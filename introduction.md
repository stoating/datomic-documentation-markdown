...
- **Indelible:** The log accumulates new information and never removes existing information. Where update-in-place databases would delete, Datomic instead adds a new [retraction](06-reference/02-transactions/02-transaction-data/transaction-data.md#op).
...
- **Tangible:** The log in Datomic is not just an implementation detail; it is an integral part of Datomic's information model. You can query the log using the [log API](04-apis/08-log-api/log-api.md).
...
[![topology-abstract](https://docs.datomic.com/images/topology-abstract.png)](https://docs.datomic.com/images/topology-abstract.png)
