...
High Availability (HA) is a Datomic Cloud feature ensuring the availability of a [compute group](../01-cloud-architecture/cloud-architecture.md#compute-groups) for reads and writes in the event of node failures.
