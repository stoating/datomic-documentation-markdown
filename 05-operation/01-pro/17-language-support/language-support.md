...
Users of other JVM languages can use the [Java API](../../../04-apis/02-peer-api-javadoc/peer-api-javadoc.md) via their respective Java interop capabilities.
...
In addition to the self-describing nature of the REST service, some basic documentation of the available endpoints is available in the REST service [documentation](../../../04-apis/09-rest-api/rest-api.md).
