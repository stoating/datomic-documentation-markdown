...
Putting domain data into your database also takes advantage of the [`transact`](../../../04-apis/01-peer-api-clojuredoc/peer-api-clojuredoc.md#transact) method of the Peer library. `transact` takes an active connection and a map of data.
